...
```{r}
logit_model_min <- glm(Status ~ SeniorCitizen + Tenure +  PhoneService + MultipleLines + InternetService + OnlineSecurity + Contract + PaperlessBilling + TotalCharges, data = model.train, family = binomial)
summary(logit_model)
```
